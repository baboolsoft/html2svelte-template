...
<main class="home-1">
  <!-- <div id="preloader" /> -->
  <div class="up">
    <a href="#" class="scrollup text-center"><i class="fas fa-chevron-up" /></a>
  </div>
  <div class="cursor" />
  ...
  <header id="bi-header" class="bi-header-section header-style-one">
    <div class="bi-header-content">
      <div
        class="bi-header-logo-main-menu d-flex align-items-center justify-content-between"
      >
        ...
        <div class="bi-header-main-menu-cta-area d-flex align-items-center">
          <div class="bi-header-main-navigation">
            <nav class="main-navigation clearfix ul-li">
              <ul id="main-nav" class="nav navbar-nav clearfix">
                <li class="nav-item">
                  <a class="nav-link active" href="#bi-slider">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#bi-about">About</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#bi-portfolio">Portfolio</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#bi-faq-testimonial">Testimonial</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#bi-fun-fact-2">Fun Fact</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#bi-blog">Blog</a>
                </li>
              </ul>
            </nav>
          </div>
          ...
          <div class="bi-header-cta-btn-grp d-flex align-items-center">
            ...
            <div class="offcanves-btn navSidebar-button">
              <button><i class="fal fa-bars" /></button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="mobile_menu_content">
            ...
            <div class="mobile-search-bar position-relative">
              <form action="#">
                ...
                <button><i class="fal fa-search" /></button>
              </form>
            </div>
            <nav class="mobile-main-navigation main-navigation clearfix ul-li">
              <ul class="nav navbar-nav clearfix">
                <li><a href="#bi-slider">Home</a></li>
                <li><a href="#bi-about">About</a></li>
                <li><a href="#bi-portfolio">Portfolio</a></li>
                <li><a href="#bi-faq-testimonial">Testimonial</a></li>
                <li><a href="#bi-fun-fact-2">Fun Fact</a></li>
                <li><a href="#bi-blog">Blog</a></li>
              </ul>
            </nav>
          ...
          <div class="sidebar-info-contents headline pera-content">
            <div class="content-inner">
              ...
              <div class="sidebar-menu ul-li-block">
                <ul>
                  <li>
                    <a href="/#"><i class="fal fa-home" /> About Us </a>
                  </li>
                  <li>
                    <a href="/#"><i class="fal fa-cogs" /> Service </a>
                  </li>
                  <li>
                    <a href="/#"
                      ><i class="fal fa-comments-alt" /> Testimonial
                    </a>
                  </li>
                  <li>
                    <a href="/#"><i class="fal fa-users" /> Our Team </a>
                  </li>
                  <li>
                    <a href="/#"><i class="fal fa-briefcase" /> Portfolio </a>
                  </li>
                  <li>
                    <a href="/#"><i class="fal fa-blog" /> Blog </a>
                  </li>
                  <!-- <li>
                    <a href="contact.html"
                      ><i class="fal fa-envelope" /> Contact
                    </a>
                  </li> -->
                </ul>
              </div>
              ...
              <!-- <div class="sidebar-social ul-li-block">
                ...
                <ul>
                  ...
                  <li><a href="#"><i class="fab fa-twitter" /> Twitter</a></li>
                  <li><a href="#"><i class="fab fa-dribbble" /> Dribble</a></li>
                  <li>
  ...
  <div class="cart_sidebar">
    <div class="cart_sidebar_top">
      ...
      <button class="cart_close_btn tx-close" />
    </div>
    <div class="cart_items_list">
      <!-- <div class="cart_item">
        ...
        <div class="item_content headline">
          ...
          <button class="remove_btn"><i class="fal fa-times" /></button>
        </div>
      </div>
      <div class="cart_item">
        <div class="item_image">
  ...
  >
    <div class="top-bg-area" data-background="assets/img/bg/top-bg.jpg">
      <!-- Start of Slider section
	============================================= -->
      <section id="bi-slider" class="bi-slider-section">
        <div class="bi-main-slider-section position-relative">
          <div
            class="bi-main-slider-area position-relative"
            data-background="assets/img/slider/slide1.png"
          >
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="bi-main-slide-item position-relative">
                    <div class="container">
                      <div
                        class="bi-main-slide-text-img-content d-flex align-items-end"
                      >
                        <div class="bi-slide-img-area position-relative">
                          ...
                          <div class="bi-slide-text-img position-absolute">
                            <img
                              src="assets/img/slider/slide_text_5.png"
                              alt=""
                            />
                          </div>
                          <div class="bi-slide-img-arrow position-absolute">
                            <img
                              src="assets/img/slider/slide_arrow_3.png"
                              alt=""
                            />
                          </div>
                        </div>
                        <div class="bi-slide-text-area headline ul-li-block">
                          <h1>Smooth</h1>
                          <h2 class="b-strock-font">Development</h2>
                          <ul>
                    ...
                    <span class="side-shape position-absolute"
                      ><img
                        src="assets/img/slider/slide_shape_4.png"
                        alt=""
                      /></span
                    >
                  </div>
            ...
            <div class="bi-carousel-arrow-next-prev position-absolute">
              <div
                class="bi-slider-arrow d-flex justify-content-center align-items-center bi-main-button-prev"
              >
                <i class="far fa-long-arrow-left" />
              </div>
              <div
                class="bi-slider-arrow d-flex justify-content-center align-items-center bi-main-button-next"
              >
        ...
        <div class="container">
          <div class="bi-skill-logo-content">
            <div class="row align-items-center">
              ...
              <div class="col-lg-8">
                <div
                  class="bi-skill-logo-wrapper wow fadeInUp"
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="bi-section-title-1 headline pera-content">
                  <div
                    class="bi-subtitle text-uppercase wow fadeInRight"
                  ...
                  <h2 class="tx-split-text split-in-right">
                    Driven by Quality & Dedicated
                  </h2>
                  <div class="bins-text">
                    <p class="bins-text">
                      We believe that great design should not be out of reach,
                      so our services are less than half the price of a
                      full-time designer.
                    </p>
                  </div>
                </div>
                <div
                  class="bi-complete-work-counter headline wow fadeInRight"
                  data-wow-delay="400ms"
                  data-wow-duration="1000ms"
                >
              ...
              <div class="col-lg-6">
                <div class="bi-quality-feature-area">
                  <div
                    class="bi-quality-feature-item position-relative d-flex align-items-center wow fadeInUp"
                    data-wow-delay="300ms"
                    data-wow-duration="1000ms"
                  >
                  ...
                  <div class="bi-about-img-text-btn">
                    <div class="bi-about-img-text pera-content bins-text">
                      <p>
                        ...
                        walk away with the solution that suits your needs
                        perfectly.
                      </p>
                    </div>
                    <div
                      class="bi-btn-1 bi-btn-area text-uppercase wow fadeInUp"
                      data-wow-delay="500ms"
                      data-wow-duration="1000ms"
                    >
                      <a class="bi-btn-main bi-btn-hover bi-btn-item" href="/#">
                        <span /> Our Company</a
                      >
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="bi-about-circle-progress-item">
                      <div
                        class="counter-boxed d-flex align-items-center pera-content headline"
                      >
    ...
    <!-- Start of Storyboard  section
	============================================= -->
    <section
      id="bi-storyboard"
      class="bi-storyboard-section position-relative"
      data-background="assets/img/bg/story-bg.jpg"
    >
      <div class="background_overlay" />
      <div class="container">
        <div class="bi-storyboard-content headline">
          <h2 class="bi-storyboard-title text-center headline-title">
            Storyboard
          </h2>
          <div class="bi-storyboard-list-area ul-li-block">
            <ul>
              <li
                class="bi-storyboard-item text-center position-relative active wow fadeInUp"
                data-wow-delay="500ms"
                data-wow-duration="1000ms"
              >
                <h3>Target Audience</h3>
                <div
                  class="bi-storyboard-hover d-flex align-items-center justify-content-center"
                >
                  <i /><span> <a href="/#">Services Price $40</a></span><i />
                </div>
              </li>
              <li
                class="bi-storyboard-item text-center position-relative wow fadeInUp"
                data-wow-delay="500ms"
                data-wow-duration="1000ms"
              >
      ...
      <div class="container">
        ...
        <div class="bi-fun-fact-counter">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
              <div
                class="bi-counter-item position-relative headline pera-content d-flex align-items-center justify-content-between"
              >
                <h3><span class="counter">10</span>x</h3>
                <p>Traffic Multiplied</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div
        ...
        <div class="bi-fun-fact-text-area">
          <div class="bi-fun-fact-text pera-content text-center bins-text">
            <p>
              No matter how big your company is, as you expand and reach new
              highs you’ll want an agency to have your back. One with a process
              that has proven itself over and over again. That’s us. We’re here
              to help you align, refine, design, and build.
            </p>
          </div>
          <div
            class="bi-btn-1 d-flex justify-content-center bi-btn-area text-uppercase wow fadeInUp"
            data-wow-delay="500ms"
            data-wow-duration="1000ms"
          >
            <a class="bi-btn-main bi-btn-hover bi-btn-item" href="/#">
        ...
        <div class="row">
          <div class="col-lg-5">
            <div class="bi-portfolio-tab-btn-text">
              <div class="bi-section-title-1 headline pera-content">
                <div class="bi-subtitle text-uppercase">ideas come to life</div>
                <h2 class="tx-split-text split-in-right">
              ...
              <div
                class="bi-portfolio-community headline wow fadeInRight"
                data-wow-delay="500ms"
                data-wow-duration="1000ms"
              >
                <div class="community-img-text ul-li d-flex align-items-center">
                  <ul>
                    <li>
                      <img src="assets/img/portfolio/test-1.jpg" alt="" />
                    </li>
                    <li>
                      <img src="assets/img/portfolio/test-2.jpg" alt="" />
                    </li>
                    <li>
                      <img src="assets/img/portfolio/test-5.jpg" alt="" />
                    </li>
                  </ul>
                  <h3>
            ...
            <div class="bi-portfolio-tab-content">
              <div class="tab-content" id="bi_portfolio_tab8">
                <div
                  ...
                  id="portfolio_1_1"
                  role="tabpanel"
                  aria-labelledby="portfolio_tab_1"
                >
                      ...
                      <div class="col-md-12">
                        <div class="bi-portfolio-item position-relative">
                          ...
                          <div class="portfolio-text headline">
                            <h3>
                              <a href="/#"
                                ><i class="fal fa-link" /> Customer Value Proposition</a
                              >
                            </h3>
                          </div>
                        </div>
                ...
                <div
                  ...
                  id="portfolio_1_3"
                  role="tabpanel"
                  aria-labelledby="portfolio_tab_2"
                >
                  <div class="bi-portfolio-item-content">
                    <div class="row">
                      <div class="col-md-12">
                ...
                <div
                  ...
                  id="portfolio_1_4"
                  role="tabpanel"
                  aria-labelledby="portfolio_tab_3"
                >
                  <div class="bi-portfolio-item-content">
                    <div class="row">
                      <div class="col-md-12">
	...
	============================================= -->
    <section
      id="bi-faq-testimonial"
      class="bi-faq-testimonial-section position-relative"
    >
      <div class="container">
        <div class="bi-faq-testimonial-content d-flex">
              ...
              <div class="accordion" id="accordionExample_31">
                  ...
                  >
                    <div class="accordion-body">
                      <div class="bi-faq-text">
                        ...
                        with modern technolo services available around Improve
                        efficiency, provide
                      </div>
                    </div>
                  </div>
                ...
                >
                  <h2 class="accordion-header" id="heading12">
                    ...
                    >
                      <span
                        >Nulla vitae est risus. Aenean aliquam dolor a massa</span
                      >
                    </button>
                  </h2>
                  <div
                ...
                >
                  <h2 class="accordion-header" id="heading13">
                    ...
                    >
                      <span
                        >Pellentesque habitant morbi tristique senectus ?</span
                      >
                    </button>
                  </h2>
                  <div
          ...
          <div class="bi-testimonial-area position-relative">
                ...
                <div class="swiper-slide">
                  <div class="bi-testimonial-item d-flex">
                    ...
                    <div class="testimonial-text headline pera-content">
                      <h3>“ QUALITY SERIVCES AND BEST REPAIR ”</h3>
                      <div class="testimonial-desc-author">
                        <p>
                          Vestibulum varius, velit sit amet tempor efficitur,
                          ligula mi lacinia libero, vehicula dui nisi eget
                          purus. Nunc rutrum sed purus eget sagittis. Improve
                          efficiency, provide
                        </p>
            ...
            <div
              class="bi-carousel-arrow-next-prev bi-carousel-testimonial d-flex"
            >
              <div
                class="bi-slider-arrow d-flex justify-content-center align-items-center testimoinal-button-prev"
              >
                <i class="far fa-long-arrow-left" />
              </div>
              <div
                class="bi-slider-arrow d-flex justify-content-center align-items-center testimoinal-button-next"
              >
                <i class="far fa-long-arrow-right" />
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-5">
              <div class="bi-fun-fact-counter-2 position-relative">
                <span class="bi-fun-fact-star position-absolute"
                  ><img src="assets/img/icon/star2.png" alt="" /></span
                >
                <div class="row">
                  <div class="col-md-6">
    ...
    >
      <div class="bi-play-btn text-center">
	...
	============================================= -->
    <section id="bi-blog" class="bi-blog-section">
      <div class="container">
        <div class="bi-section-title-1 text-center headline pera-content">
          <div
            class="bi-subtitle text-uppercase wow fadeInRight"
              ...
              <div class="col-lg-6">
                <div class="bi-blog-text-area headline pera-content">
                  <div class="bi-blog-meta text-uppercase position-relative">
                    <a href="#"
                      ><i class="fal fa-calendar-alt" /> October 6, 2023</a
                    >
                  </div>
                  <div class="bi-blog-text">
                    <h3 class="tx-split-text split-in-right">
                      <a href="/#">Working Together, ideas Come to Life</a>
                    </h3>
                    <div class="bins-text">
                      <p>
                        No matter how big your company is, as you expand and
                        reach new highs you’ll want an agency to have your back.
                        One with a process that has proven itself over and over
                        again.
                      </p>
                    </div>
                    <div
                      class="bi-btn-1 bi-btn-area text-uppercase wow fadeInRight"
                      data-wow-delay="200ms"
                      data-wow-duration="1000ms"
                    >
                      <a class="bi-btn-main bi-btn-hover bi-btn-item" href="/#">
  ...
  <footer
    id="bi-footer"
    class="bi-footer-section"
    data-background="assets/img/bg/footer-bg.jpg"
  >
    <div class="bi-footer-cta position-relative">
      <div class="container">
        <div
          class="bi-footer-cta-content headline d-flex align-items-center justify-content-between flex-wrap"
          ...
          <div class="col-lg-5">
            <div class="bi-footer-widget headline pera-content ul-li-block">
              <div class="about-widget">
                ...
                <p>
                  No matter how big your company is, as you expand and reach new
                  highs you’ll want an agency to have your back. One with a
                  process
                </p>
              </div>
            </div>
    ...
    <div class="bi-footer-social">
      <div class="container">
        <div class="bi-footer-social-content ul-li">
          <ul>
            <li>
              <a href="#"><i class="fal fa-basketball-ball" /> Dribbble </a>
            </li>
            <li>
              <a href="#"><i class="fab fa-behance-square" /> Behance </a>
            </li>
            <li><a href="#"><i class="fab fa-linkedin-in" /> Linked In </a></li>
            <li><a href="#"><i class="fab fa-facebook-f" /> Facebook </a></li>
            <li><a href="#"><i class="fab fa-instagram" /> Instagram </a></li>
            <li><a href="#"><i class="fab fa-youtube" /> Youtube </a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="bi-footer-copyright text-center">Copyright 2023 @webagency</div>
  </footer>
</main>
